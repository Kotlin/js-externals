...
external interface DetailedHTMLFactory<P : HTMLAttributes<T>, T : HTMLElement> : (props: ClassAttributes<T>? /* ClassAttributes<T> & P */ /*= null*/, children: dynamic /* String | Number | Boolean | Any? | ReactElement<Any> | Array<dynamic /* String | Number | Boolean | Array<Any> | ReactElement<Any> */> | ReactPortal | Nothing? */) -> DOMElement<P, T> {
    ...
    @nativeInvoke
    operator fun invoke(props: ClassAttributes<T>? /* ClassAttributes<T> & P */ = definedExternally /* null */, vararg children: ReactPortal): DetailedReactHTMLElement<P, T>
    @nativeInvoke
...
external interface SVGFactory : (props: ClassAttributes<SVGElement>? /* ClassAttributes<T> & P */ /*= null*/, children: dynamic /* String | Number | Boolean | Any? | ReactElement<Any> | Array<dynamic /* String | Number | Boolean | Array<Any> | ReactElement<Any> */> | ReactPortal | Nothing? */) -> DOMElement<SVGAttributes<SVGElement>, SVGElement> {
    @nativeInvoke
    ...
    @nativeInvoke
    operator fun invoke(props: ClassAttributes<SVGElement>? /* ClassAttributes<SVGElement> & SVGAttributes<SVGElement> */ = definedExternally /* null */, vararg children: ReactPortal): ReactSVGElement
    @nativeInvoke
...
external fun createElement(type: String /* "input" */, props: InputHTMLAttributes<HTMLInputElement>? /* InputHTMLAttributes<HTMLInputElement> & ClassAttributes<HTMLInputElement> */ = definedExternally /* null */, vararg children: ReactPortal): DetailedReactHTMLElement<InputHTMLAttributes<HTMLInputElement>, HTMLInputElement> = definedExternally
...
external fun <P : HTMLAttributes<T>, T : HTMLElement> createElement(type: dynamic /* String /* "object" */ | String /* "a" */ | String /* "abbr" */ | String /* "address" */ | String /* "area" */ | String /* "article" */ | String /* "aside" */ | String /* "audio" */ | String /* "b" */ | String /* "base" */ | String /* "bdi" */ | String /* "bdo" */ | String /* "big" */ | String /* "blockquote" */ | String /* "body" */ | String /* "br" */ | String /* "button" */ | String /* "canvas" */ | String /* "caption" */ | String /* "cite" */ | String /* "code" */ | String /* "col" */ | String /* "colgroup" */ | String /* "data" */ | String /* "datalist" */ | String /* "dd" */ | String /* "del" */ | String /* "details" */ | String /* "dfn" */ | String /* "dialog" */ | String /* "div" */ | String /* "dl" */ | String /* "dt" */ | String /* "em" */ | String /* "embed" */ | String /* "fieldset" */ | String /* "figcaption" */ | String /* "figure" */ | String /* "footer" */ | String /* "form" */ | String /* "h1" */ | String /* "h2" */ | String /* "h3" */ | String /* "h4" */ | String /* "h5" */ | String /* "h6" */ | String /* "head" */ | String /* "header" */ | String /* "hgroup" */ | String /* "hr" */ | String /* "html" */ | String /* "i" */ | String /* "iframe" */ | String /* "img" */ | String /* "input" */ | String /* "ins" */ | String /* "kbd" */ | String /* "keygen" */ | String /* "label" */ | String /* "legend" */ | String /* "li" */ | String /* "link" */ | String /* "main" */ | String /* "map" */ | String /* "mark" */ | String /* "menu" */ | String /* "menuitem" */ | String /* "meta" */ | String /* "meter" */ | String /* "nav" */ | String /* "noscript" */ | String /* "ol" */ | String /* "optgroup" */ | String /* "option" */ | String /* "output" */ | String /* "p" */ | String /* "param" */ | String /* "picture" */ | String /* "pre" */ | String /* "progress" */ | String /* "q" */ | String /* "rp" */ | String /* "rt" */ | String /* "ruby" */ | String /* "s" */ | String /* "samp" */ | String /* "script" */ | String /* "section" */ | String /* "select" */ | String /* "small" */ | String /* "source" */ | String /* "span" */ | String /* "strong" */ | String /* "style" */ | String /* "sub" */ | String /* "summary" */ | String /* "sup" */ | String /* "table" */ | String /* "tbody" */ | String /* "td" */ | String /* "textarea" */ | String /* "tfoot" */ | String /* "th" */ | String /* "thead" */ | String /* "time" */ | String /* "title" */ | String /* "tr" */ | String /* "track" */ | String /* "u" */ | String /* "ul" */ | String /* "var" */ | String /* "video" */ | String /* "wbr" */ | String /* "webview" */ */, props: ClassAttributes<T>? /* ClassAttributes<T> & P */ = definedExternally /* null */, vararg children: ReactPortal): DetailedReactHTMLElement<P, T> = definedExternally
...
external fun <P : SVGAttributes<T>, T : SVGElement> createElement(type: dynamic /* String /* "symbol" */ | String /* "animate" */ | String /* "circle" */ | String /* "clipPath" */ | String /* "defs" */ | String /* "desc" */ | String /* "ellipse" */ | String /* "feBlend" */ | String /* "feColorMatrix" */ | String /* "feComponentTransfer" */ | String /* "feComposite" */ | String /* "feConvolveMatrix" */ | String /* "feDiffuseLighting" */ | String /* "feDisplacementMap" */ | String /* "feDistantLight" */ | String /* "feDropShadow" */ | String /* "feFlood" */ | String /* "feFuncA" */ | String /* "feFuncB" */ | String /* "feFuncG" */ | String /* "feFuncR" */ | String /* "feGaussianBlur" */ | String /* "feImage" */ | String /* "feMerge" */ | String /* "feMergeNode" */ | String /* "feMorphology" */ | String /* "feOffset" */ | String /* "fePointLight" */ | String /* "feSpecularLighting" */ | String /* "feSpotLight" */ | String /* "feTile" */ | String /* "feTurbulence" */ | String /* "filter" */ | String /* "foreignObject" */ | String /* "g" */ | String /* "image" */ | String /* "line" */ | String /* "linearGradient" */ | String /* "marker" */ | String /* "mask" */ | String /* "metadata" */ | String /* "path" */ | String /* "pattern" */ | String /* "polygon" */ | String /* "polyline" */ | String /* "radialGradient" */ | String /* "rect" */ | String /* "stop" */ | String /* "svg" */ | String /* "switch" */ | String /* "text" */ | String /* "textPath" */ | String /* "tspan" */ | String /* "use" */ | String /* "view" */ */, props: ClassAttributes<T>? /* ClassAttributes<T> & P */ = definedExternally /* null */, vararg children: String): ReactSVGElement = definedExternally
external fun <P : SVGAttributes<T>, T : SVGElement> createElement(type: dynamic /* String /* "symbol" */ | String /* "animate" */ | String /* "circle" */ | String /* "clipPath" */ | String /* "defs" */ | String /* "desc" */ | String /* "ellipse" */ | String /* "feBlend" */ | String /* "feColorMatrix" */ | String /* "feComponentTransfer" */ | String /* "feComposite" */ | String /* "feConvolveMatrix" */ | String /* "feDiffuseLighting" */ | String /* "feDisplacementMap" */ | String /* "feDistantLight" */ | String /* "feDropShadow" */ | String /* "feFlood" */ | String /* "feFuncA" */ | String /* "feFuncB" */ | String /* "feFuncG" */ | String /* "feFuncR" */ | String /* "feGaussianBlur" */ | String /* "feImage" */ | String /* "feMerge" */ | String /* "feMergeNode" */ | String /* "feMorphology" */ | String /* "feOffset" */ | String /* "fePointLight" */ | String /* "feSpecularLighting" */ | String /* "feSpotLight" */ | String /* "feTile" */ | String /* "feTurbulence" */ | String /* "filter" */ | String /* "foreignObject" */ | String /* "g" */ | String /* "image" */ | String /* "line" */ | String /* "linearGradient" */ | String /* "marker" */ | String /* "mask" */ | String /* "metadata" */ | String /* "path" */ | String /* "pattern" */ | String /* "polygon" */ | String /* "polyline" */ | String /* "radialGradient" */ | String /* "rect" */ | String /* "stop" */ | String /* "svg" */ | String /* "switch" */ | String /* "text" */ | String /* "textPath" */ | String /* "tspan" */ | String /* "use" */ | String /* "view" */ */, props: ClassAttributes<T>? /* ClassAttributes<T> & P */ = definedExternally /* null */, vararg children: Number): ReactSVGElement = definedExternally
external fun <P : SVGAttributes<T>, T : SVGElement> createElement(type: dynamic /* String /* "symbol" */ | String /* "animate" */ | String /* "circle" */ | String /* "clipPath" */ | String /* "defs" */ | String /* "desc" */ | String /* "ellipse" */ | String /* "feBlend" */ | String /* "feColorMatrix" */ | String /* "feComponentTransfer" */ | String /* "feComposite" */ | String /* "feConvolveMatrix" */ | String /* "feDiffuseLighting" */ | String /* "feDisplacementMap" */ | String /* "feDistantLight" */ | String /* "feDropShadow" */ | String /* "feFlood" */ | String /* "feFuncA" */ | String /* "feFuncB" */ | String /* "feFuncG" */ | String /* "feFuncR" */ | String /* "feGaussianBlur" */ | String /* "feImage" */ | String /* "feMerge" */ | String /* "feMergeNode" */ | String /* "feMorphology" */ | String /* "feOffset" */ | String /* "fePointLight" */ | String /* "feSpecularLighting" */ | String /* "feSpotLight" */ | String /* "feTile" */ | String /* "feTurbulence" */ | String /* "filter" */ | String /* "foreignObject" */ | String /* "g" */ | String /* "image" */ | String /* "line" */ | String /* "linearGradient" */ | String /* "marker" */ | String /* "mask" */ | String /* "metadata" */ | String /* "path" */ | String /* "pattern" */ | String /* "polygon" */ | String /* "polyline" */ | String /* "radialGradient" */ | String /* "rect" */ | String /* "stop" */ | String /* "svg" */ | String /* "switch" */ | String /* "text" */ | String /* "textPath" */ | String /* "tspan" */ | String /* "use" */ | String /* "view" */ */, props: ClassAttributes<T>? /* ClassAttributes<T> & P */ = definedExternally /* null */, vararg children: Boolean): ReactSVGElement = definedExternally
external fun <P : SVGAttributes<T>, T : SVGElement> createElement(type: dynamic /* String /* "symbol" */ | String /* "animate" */ | String /* "circle" */ | String /* "clipPath" */ | String /* "defs" */ | String /* "desc" */ | String /* "ellipse" */ | String /* "feBlend" */ | String /* "feColorMatrix" */ | String /* "feComponentTransfer" */ | String /* "feComposite" */ | String /* "feConvolveMatrix" */ | String /* "feDiffuseLighting" */ | String /* "feDisplacementMap" */ | String /* "feDistantLight" */ | String /* "feDropShadow" */ | String /* "feFlood" */ | String /* "feFuncA" */ | String /* "feFuncB" */ | String /* "feFuncG" */ | String /* "feFuncR" */ | String /* "feGaussianBlur" */ | String /* "feImage" */ | String /* "feMerge" */ | String /* "feMergeNode" */ | String /* "feMorphology" */ | String /* "feOffset" */ | String /* "fePointLight" */ | String /* "feSpecularLighting" */ | String /* "feSpotLight" */ | String /* "feTile" */ | String /* "feTurbulence" */ | String /* "filter" */ | String /* "foreignObject" */ | String /* "g" */ | String /* "image" */ | String /* "line" */ | String /* "linearGradient" */ | String /* "marker" */ | String /* "mask" */ | String /* "metadata" */ | String /* "path" */ | String /* "pattern" */ | String /* "polygon" */ | String /* "polyline" */ | String /* "radialGradient" */ | String /* "rect" */ | String /* "stop" */ | String /* "svg" */ | String /* "switch" */ | String /* "text" */ | String /* "textPath" */ | String /* "tspan" */ | String /* "use" */ | String /* "view" */ */, props: ClassAttributes<T>? /* ClassAttributes<T> & P */ = definedExternally /* null */, vararg children: Any?): ReactSVGElement = definedExternally
external fun <P : SVGAttributes<T>, T : SVGElement> createElement(type: dynamic /* String /* "symbol" */ | String /* "animate" */ | String /* "circle" */ | String /* "clipPath" */ | String /* "defs" */ | String /* "desc" */ | String /* "ellipse" */ | String /* "feBlend" */ | String /* "feColorMatrix" */ | String /* "feComponentTransfer" */ | String /* "feComposite" */ | String /* "feConvolveMatrix" */ | String /* "feDiffuseLighting" */ | String /* "feDisplacementMap" */ | String /* "feDistantLight" */ | String /* "feDropShadow" */ | String /* "feFlood" */ | String /* "feFuncA" */ | String /* "feFuncB" */ | String /* "feFuncG" */ | String /* "feFuncR" */ | String /* "feGaussianBlur" */ | String /* "feImage" */ | String /* "feMerge" */ | String /* "feMergeNode" */ | String /* "feMorphology" */ | String /* "feOffset" */ | String /* "fePointLight" */ | String /* "feSpecularLighting" */ | String /* "feSpotLight" */ | String /* "feTile" */ | String /* "feTurbulence" */ | String /* "filter" */ | String /* "foreignObject" */ | String /* "g" */ | String /* "image" */ | String /* "line" */ | String /* "linearGradient" */ | String /* "marker" */ | String /* "mask" */ | String /* "metadata" */ | String /* "path" */ | String /* "pattern" */ | String /* "polygon" */ | String /* "polyline" */ | String /* "radialGradient" */ | String /* "rect" */ | String /* "stop" */ | String /* "svg" */ | String /* "switch" */ | String /* "text" */ | String /* "textPath" */ | String /* "tspan" */ | String /* "use" */ | String /* "view" */ */, props: ClassAttributes<T>? /* ClassAttributes<T> & P */ = definedExternally /* null */, vararg children: ReactElement<Any>): ReactSVGElement = definedExternally
external fun <P : SVGAttributes<T>, T : SVGElement> createElement(type: dynamic /* String /* "symbol" */ | String /* "animate" */ | String /* "circle" */ | String /* "clipPath" */ | String /* "defs" */ | String /* "desc" */ | String /* "ellipse" */ | String /* "feBlend" */ | String /* "feColorMatrix" */ | String /* "feComponentTransfer" */ | String /* "feComposite" */ | String /* "feConvolveMatrix" */ | String /* "feDiffuseLighting" */ | String /* "feDisplacementMap" */ | String /* "feDistantLight" */ | String /* "feDropShadow" */ | String /* "feFlood" */ | String /* "feFuncA" */ | String /* "feFuncB" */ | String /* "feFuncG" */ | String /* "feFuncR" */ | String /* "feGaussianBlur" */ | String /* "feImage" */ | String /* "feMerge" */ | String /* "feMergeNode" */ | String /* "feMorphology" */ | String /* "feOffset" */ | String /* "fePointLight" */ | String /* "feSpecularLighting" */ | String /* "feSpotLight" */ | String /* "feTile" */ | String /* "feTurbulence" */ | String /* "filter" */ | String /* "foreignObject" */ | String /* "g" */ | String /* "image" */ | String /* "line" */ | String /* "linearGradient" */ | String /* "marker" */ | String /* "mask" */ | String /* "metadata" */ | String /* "path" */ | String /* "pattern" */ | String /* "polygon" */ | String /* "polyline" */ | String /* "radialGradient" */ | String /* "rect" */ | String /* "stop" */ | String /* "svg" */ | String /* "switch" */ | String /* "text" */ | String /* "textPath" */ | String /* "tspan" */ | String /* "use" */ | String /* "view" */ */, props: ClassAttributes<T>? /* ClassAttributes<T> & P */ = definedExternally /* null */, vararg children: Array<dynamic /* String | Number | Boolean | Array<Any> | ReactElement<Any> */>): ReactSVGElement = definedExternally
external fun <P : SVGAttributes<T>, T : SVGElement> createElement(type: dynamic /* String /* "symbol" */ | String /* "animate" */ | String /* "circle" */ | String /* "clipPath" */ | String /* "defs" */ | String /* "desc" */ | String /* "ellipse" */ | String /* "feBlend" */ | String /* "feColorMatrix" */ | String /* "feComponentTransfer" */ | String /* "feComposite" */ | String /* "feConvolveMatrix" */ | String /* "feDiffuseLighting" */ | String /* "feDisplacementMap" */ | String /* "feDistantLight" */ | String /* "feDropShadow" */ | String /* "feFlood" */ | String /* "feFuncA" */ | String /* "feFuncB" */ | String /* "feFuncG" */ | String /* "feFuncR" */ | String /* "feGaussianBlur" */ | String /* "feImage" */ | String /* "feMerge" */ | String /* "feMergeNode" */ | String /* "feMorphology" */ | String /* "feOffset" */ | String /* "fePointLight" */ | String /* "feSpecularLighting" */ | String /* "feSpotLight" */ | String /* "feTile" */ | String /* "feTurbulence" */ | String /* "filter" */ | String /* "foreignObject" */ | String /* "g" */ | String /* "image" */ | String /* "line" */ | String /* "linearGradient" */ | String /* "marker" */ | String /* "mask" */ | String /* "metadata" */ | String /* "path" */ | String /* "pattern" */ | String /* "polygon" */ | String /* "polyline" */ | String /* "radialGradient" */ | String /* "rect" */ | String /* "stop" */ | String /* "svg" */ | String /* "switch" */ | String /* "text" */ | String /* "textPath" */ | String /* "tspan" */ | String /* "use" */ | String /* "view" */ */, props: ClassAttributes<T>? /* ClassAttributes<T> & P */ = definedExternally /* null */, vararg children: ReactPortal): ReactSVGElement = definedExternally
external fun <P : SVGAttributes<T>, T : SVGElement> createElement(type: dynamic /* String /* "symbol" */ | String /* "animate" */ | String /* "circle" */ | String /* "clipPath" */ | String /* "defs" */ | String /* "desc" */ | String /* "ellipse" */ | String /* "feBlend" */ | String /* "feColorMatrix" */ | String /* "feComponentTransfer" */ | String /* "feComposite" */ | String /* "feConvolveMatrix" */ | String /* "feDiffuseLighting" */ | String /* "feDisplacementMap" */ | String /* "feDistantLight" */ | String /* "feDropShadow" */ | String /* "feFlood" */ | String /* "feFuncA" */ | String /* "feFuncB" */ | String /* "feFuncG" */ | String /* "feFuncR" */ | String /* "feGaussianBlur" */ | String /* "feImage" */ | String /* "feMerge" */ | String /* "feMergeNode" */ | String /* "feMorphology" */ | String /* "feOffset" */ | String /* "fePointLight" */ | String /* "feSpecularLighting" */ | String /* "feSpotLight" */ | String /* "feTile" */ | String /* "feTurbulence" */ | String /* "filter" */ | String /* "foreignObject" */ | String /* "g" */ | String /* "image" */ | String /* "line" */ | String /* "linearGradient" */ | String /* "marker" */ | String /* "mask" */ | String /* "metadata" */ | String /* "path" */ | String /* "pattern" */ | String /* "polygon" */ | String /* "polyline" */ | String /* "radialGradient" */ | String /* "rect" */ | String /* "stop" */ | String /* "svg" */ | String /* "switch" */ | String /* "text" */ | String /* "textPath" */ | String /* "tspan" */ | String /* "use" */ | String /* "view" */ */, props: ClassAttributes<T>? /* ClassAttributes<T> & P */ = definedExternally /* null */, vararg children: Nothing?): ReactSVGElement = definedExternally
...
external fun <P : DOMAttributes<T>, T : Element> createElement(type: String, props: ClassAttributes<T>? /* ClassAttributes<T> & P */ = definedExternally /* null */, vararg children: ReactPortal): DOMElement<P, T> = definedExternally
...
external fun <P : HTMLAttributes<T>, T : HTMLElement> cloneElement(element: DetailedReactHTMLElement<P, T>, props: P? = definedExternally /* null */, vararg children: ReactPortal): DetailedReactHTMLElement<P, T> = definedExternally
...
external fun <P : HTMLAttributes<T>, T : HTMLElement> cloneElement(element: ReactHTMLElement<T>, props: P? = definedExternally /* null */, vararg children: ReactPortal): ReactHTMLElement<T> = definedExternally
...
external fun <P : SVGAttributes<T>, T : SVGElement> cloneElement(element: ReactSVGElement, props: P? = definedExternally /* null */, vararg children: ReactPortal): ReactSVGElement = definedExternally
...
external fun <P : DOMAttributes<T>, T : Element> cloneElement(element: DOMElement<P, T>, props: DOMAttributes<T>? /* DOMAttributes<T> & P */ = definedExternally /* null */, vararg children: ReactPortal): DOMElement<P, T> = definedExternally
...
external fun <P : Q, Q> cloneElement(element: ReactElement<P>, props: Q? = definedExternally /* null */, vararg children: ReactPortal): ReactElement<P> = definedExternally
...
external var Fragment: dynamic /* ComponentClass<Any?> | StatelessComponent<Any?> */ = definedExternally
external var version: String = definedExternally
external open class Component<P, S>(props: P, context: Any? = definedExternally /* null */) : ComponentLifecycle<P, S> {
    open fun <K : Any?> setState(state: S, callback: (() -> Unit)? = definedExternally /* null */): Unit = definedExternally
    open fun <K : Any?> setState(state: (prevState: Any?, props: P) -> dynamic /* S | Any? */, callback: (() -> Unit)? = definedExternally /* null */): Unit = definedExternally
    open fun <K : Any?> setState(state: Any?, callback: (() -> Unit)? = definedExternally /* null */): Unit = definedExternally
    open fun forceUpdate(callBack: (() -> Unit)? = definedExternally /* null */): Unit = definedExternally
    open fun render(): dynamic /* String | Number | Boolean | Any? | ReactElement<Any> | Array<dynamic /* String | Number | Boolean | Array<Any> | ReactElement<Any> */> | ReactPortal | Nothing? */ = definedExternally
...
external interface ClassicComponent<P, S> : Component<P, S> {
    fun replaceState(nextState: S, callback: (() -> Unit)? = definedExternally /* null */)
...
external interface `T$1` {
    var children: dynamic /* String | Number | Boolean | Any? | ReactElement<Any> | Array<dynamic /* String | Number | Boolean | Array<Any> | ReactElement<Any> */> | ReactPortal | Nothing? */ get() = definedExternally; set(value) = definedExternally
}
...
external interface ComponentLifecycle<P, S> {
    ...
    val componentDidCatch: ((error: Error, errorInfo: ErrorInfo) -> Unit)? get() = definedExternally
}
...
external interface ComponentSpec<P, S> : Mixin<P, S> {
    fun render(): dynamic /* String | Number | Boolean | Any? | ReactElement<Any> | Array<dynamic /* String | Number | Boolean | Array<Any> | ReactElement<Any> */> | ReactPortal | Nothing? */
    @nativeGetter
...
external interface CSSProperties {
    ...
    var backgroundSize: dynamic /* String /* "initial" */ | String /* "inherit" */ | String /* "unset" */ | Any */ get() = definedExternally; set(value) = definedExternally
    ...
    var borderBottomLeftRadius: dynamic /* String | Number */ get() = definedExternally; set(value) = definedExternally
    var borderBottomRightRadius: dynamic /* String | Number */ get() = definedExternally; set(value) = definedExternally
    ...
    var borderRadius: dynamic /* String | Number */ get() = definedExternally; set(value) = definedExternally
    ...
    var borderTopLeftRadius: dynamic /* String | Number */ get() = definedExternally; set(value) = definedExternally
    var borderTopRightRadius: dynamic /* String | Number */ get() = definedExternally; set(value) = definedExternally
    ...
    var justifyContent: dynamic /* String /* "initial" */ | String /* "inherit" */ | String /* "unset" */ | String /* "flex-start" */ | String /* "flex-end" */ | String /* "center" */ | String /* "space-between" */ | String /* "space-around" */ | String /* "stretch" */ | String /* "space-evenly" */ */ get() = definedExternally; set(value) = definedExternally
...
external interface MediaHTMLAttributes<T> : HTMLAttributes<T> {
    var autoPlay: Boolean? get() = definedExternally; set(value) = definedExternally
    var controls: Boolean? get() = definedExternally; set(value) = definedExternally
    var controlsList: String? get() = definedExternally; set(value) = definedExternally
    var crossOrigin: String? get() = definedExternally; set(value) = definedExternally
    var loop: Boolean? get() = definedExternally; set(value) = definedExternally
    var mediaGroup: String? get() = definedExternally; set(value) = definedExternally
    var muted: Boolean? get() = definedExternally; set(value) = definedExternally
...
external interface ReactChildren {
    ...
    fun <T> map(children: ReactPortal, fn: (child: dynamic /* String | Number | ReactElement<Any> */, index: Number) -> T): Array<T>
    fun <T> map(children: Nothing?, fn: (child: dynamic /* String | Number | ReactElement<Any> */, index: Number) -> T): Array<T>
    fun forEach(children: String, fn: (child: dynamic /* String | Number | ReactElement<Any> */, index: Number) -> Unit)
    fun forEach(children: Number, fn: (child: dynamic /* String | Number | ReactElement<Any> */, index: Number) -> Unit)
    fun forEach(children: Boolean, fn: (child: dynamic /* String | Number | ReactElement<Any> */, index: Number) -> Unit)
    fun forEach(children: Any?, fn: (child: dynamic /* String | Number | ReactElement<Any> */, index: Number) -> Unit)
    fun forEach(children: ReactElement<Any>, fn: (child: dynamic /* String | Number | ReactElement<Any> */, index: Number) -> Unit)
    fun forEach(children: Array<dynamic /* String | Number | Boolean | Array<Any> | ReactElement<Any> */>, fn: (child: dynamic /* String | Number | ReactElement<Any> */, index: Number) -> Unit)
    fun forEach(children: ReactPortal, fn: (child: dynamic /* String | Number | ReactElement<Any> */, index: Number) -> Unit)
    fun forEach(children: Nothing?, fn: (child: dynamic /* String | Number | ReactElement<Any> */, index: Number) -> Unit)
    ...
    fun count(children: ReactPortal): Number
    ...
    fun only(children: ReactPortal): ReactElement<Any>
    ...
    fun toArray(children: ReactPortal): Array<dynamic /* String | Number | ReactElement<Any> */>
