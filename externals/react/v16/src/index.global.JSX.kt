...
external interface ElementClass : React.Component<Any, Any?> {
    override fun render(): dynamic /* String | Number | Boolean | Any? | React.ReactElement<Any> | Array<dynamic /* String | Number | Boolean | Array<Any> | React.ReactElement<Any> */> | React.ReactPortal | Nothing? */
}
...
//    var webview: React.ClassAttributes<HTMLWebViewElement> /* React.ClassAttributes<HTMLWebViewElement> & React.WebViewHTMLAttributes<HTMLWebViewElement> */
