...
external interface SuccessCallback<TContext> {
    @nativeInvoke
    operator fun invoke(`this`: TContext, data: Any, textStatus: String /* "success" */, jqXHR: JQuery.jqXHR<Any>)
    @nativeInvoke
    operator fun invoke(`this`: TContext, data: Any, textStatus: String /* "notmodified" */, jqXHR: JQuery.jqXHR<Any>)
    @nativeInvoke
    operator fun invoke(`this`: TContext, data: Any, textStatus: String /* "nocontent" */, jqXHR: JQuery.jqXHR<Any>)
}
external interface ErrorCallback<TContext> {
    @nativeInvoke
    operator fun invoke(`this`: TContext, jqXHR: JQuery.jqXHR<Any>, textStatus: String /* "error" */, errorThrown: String)
    @nativeInvoke
    operator fun invoke(`this`: TContext, jqXHR: JQuery.jqXHR<Any>, textStatus: String /* "timeout" */, errorThrown: String)
    @nativeInvoke
    operator fun invoke(`this`: TContext, jqXHR: JQuery.jqXHR<Any>, textStatus: String /* "abort" */, errorThrown: String)
    @nativeInvoke
    operator fun invoke(`this`: TContext, jqXHR: JQuery.jqXHR<Any>, textStatus: String /* "parsererror" */, errorThrown: String)
}
external interface CompleteCallback<TContext> {
    @nativeInvoke
    operator fun invoke(`this`: TContext, jqXHR: JQuery.jqXHR<Any>, textStatus: String /* "error" */)
    @nativeInvoke
    operator fun invoke(`this`: TContext, jqXHR: JQuery.jqXHR<Any>, textStatus: String /* "success" */)
    @nativeInvoke
    operator fun invoke(`this`: TContext, jqXHR: JQuery.jqXHR<Any>, textStatus: String /* "notmodified" */)
    @nativeInvoke
    operator fun invoke(`this`: TContext, jqXHR: JQuery.jqXHR<Any>, textStatus: String /* "nocontent" */)
    @nativeInvoke
    operator fun invoke(`this`: TContext, jqXHR: JQuery.jqXHR<Any>, textStatus: String /* "timeout" */)
    @nativeInvoke
    operator fun invoke(`this`: TContext, jqXHR: JQuery.jqXHR<Any>, textStatus: String /* "abort" */)
    @nativeInvoke
    operator fun invoke(`this`: TContext, jqXHR: JQuery.jqXHR<Any>, textStatus: String /* "parsererror" */)
}
...
external interface AjaxSettingsBase<TContext> {
    var accepts: JQuery.PlainObject<String>? get() = definedExternally; set(value) = definedExternally
    var async: Boolean? get() = definedExternally; set(value) = definedExternally
    val beforeSend: ((`this`: TContext, jqXHR: JQuery.jqXHR<Any>, settings: AjaxSettingsBase<TContext>) -> dynamic /* Boolean | Unit */)? get() = definedExternally
    ...
    var contents: JQuery.PlainObject<RegExp>? get() = definedExternally; set(value) = definedExternally
    ...
    var converters: JQuery.PlainObject<dynamic /* Boolean | (value: Any) -> Any */>? get() = definedExternally; set(value) = definedExternally
    var crossDomain: Boolean? get() = definedExternally; set(value) = definedExternally
    var data: dynamic /* String | JQuery.PlainObject<Any> */ get() = definedExternally; set(value) = definedExternally
    ...
    var headers: JQuery.PlainObject<String?>? get() = definedExternally; set(value) = definedExternally
    ...
    var statusCode: `T$2`? /* `T$2` & `T$3` */ get() = definedExternally; set(value) = definedExternally
