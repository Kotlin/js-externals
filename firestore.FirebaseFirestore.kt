...
external open class Transaction {
    ...
    open fun getAll(vararg documentRef: DocumentReference): Promise<Array<DocumentSnapshot>> = definedExternally
    open fun create(documentRef: DocumentReference, data: FirebaseFirestore.DocumentData): Transaction = definedExternally
    open fun set(documentRef: DocumentReference, data: FirebaseFirestore.DocumentData, options: SetOptions? = definedExternally /* null */): Transaction = definedExternally
    open fun update(documentRef: DocumentReference, data: FirebaseFirestore.UpdateData, precondition: Precondition? = definedExternally /* null */): Transaction = definedExternally
...
external open class WriteBatch {
    open fun create(documentRef: DocumentReference, data: FirebaseFirestore.DocumentData): WriteBatch = definedExternally
    open fun set(documentRef: DocumentReference, data: FirebaseFirestore.DocumentData, options: SetOptions? = definedExternally /* null */): WriteBatch = definedExternally
    open fun update(documentRef: DocumentReference, data: FirebaseFirestore.UpdateData, precondition: Precondition? = definedExternally /* null */): WriteBatch = definedExternally
...
external open class DocumentReference {
    ...
    open fun collection(collectionPath: String): CollectionReference = definedExternally
    open fun getCollections(): Promise<Array<CollectionReference>> = definedExternally
    open fun create(data: FirebaseFirestore.DocumentData): Promise<WriteResult> = definedExternally
    open fun set(data: FirebaseFirestore.DocumentData, options: SetOptions? = definedExternally /* null */): Promise<WriteResult> = definedExternally
    open fun update(data: FirebaseFirestore.UpdateData, precondition: Precondition? = definedExternally /* null */): Promise<WriteResult> = definedExternally
...
external open class DocumentSnapshot {
    ...
    open fun data(): FirebaseFirestore.DocumentData? = definedExternally
...
external open class QueryDocumentSnapshot : DocumentSnapshot {
    ...
    override fun data(): FirebaseFirestore.DocumentData = definedExternally
}
external open class Query {
    ...
    open fun stream(): NodeJS.ReadableStream = definedExternally
...
external open class CollectionReference : Query {
    ...
    open fun add(data: FirebaseFirestore.DocumentData): Promise<DocumentReference> = definedExternally
